...
`;
  const MOBILE_OVERVIEW_PRODUCT_STYLES = `
...
@media (max-width: 760px) {
  ...
  /* v980: App information architecture pass.
     The first screen is now a compact judgment rail + one scene visual, not a
     desktop report squeezed into card blocks.  Colour becomes evidence, not
     decoration: red is a mark, blue is structure, grey carries hierarchy. */
  #overview.router-overview-framework .ik-v420-screen,
  .router-overview-framework .ik-v420-screen,
  .ik-v420-screen {
    padding: max(4px, env(safe-area-inset-top, 0px)) 13px calc(66px + env(safe-area-inset-bottom, 0px)) !important;
  }
  ...
  .ik-v940-core-rail {
    display: grid !important;
    grid-template-columns: .82fr .78fr .88fr 1fr 1.02fr !important;
    height: 38px !important;
    min-height: 38px !important;
    overflow: hidden !important;
    border: 0 !important;
    border-radius: 0 !important;
    background: rgba(247,250,253,.68) !important;
    box-shadow: inset 0 1px 0 rgba(145,169,193,.22), inset 0 -1px 0 rgba(145,169,193,.22) !important;
  }
  ...
  .ik-v940-core-rail span {
    display: grid !important;
    grid-template-rows: 10px 13px 10px !important;
    align-content: center !important;
    min-width: 0 !important;
    padding: 2px 5px !important;
    border-left: 1px solid rgba(164,184,205,.20) !important;
    background: transparent !important;
  }
  ...
  .ik-v420-hero {
    ...
    grid-template-rows: auto minmax(66px, auto) 16px !important;
    gap: 3px !important;
    padding: 6px 9px 5px !important;
    background: rgba(255,255,255,.62) !important;
    box-shadow: inset 0 1px 0 rgba(160,181,202,.20), inset 0 -1px 0 rgba(160,181,202,.20) !important;
  }
  ...
  .ik-v420-port-matrix {
    min-height: 62px !important;
    border: 1px solid rgba(164,184,205,.34) !important;
    border-right: 0 !important;
    border-bottom: 0 !important;
    background: rgba(248,251,254,.62) !important;
  }
  ...
  .ik-v420-port-matrix span {
    ...
    padding: 2px 5px 2px 0 !important;
    border-radius: 0 !important;
    border-right: 1px solid rgba(164,184,205,.30) !important;
    border-bottom: 1px solid rgba(164,184,205,.30) !important;
    box-shadow: none !important;
  }
  ...
  .router-overview-framework .ik-v420-resource-visual.ik-v620-pressure-visual .ik-v420-resource-meter,
  .ik-v420-resource-visual.ik-v620-pressure-visual .ik-v420-resource-meter {
    grid-template-columns: 24px 31px 32px 36px minmax(0, 1fr) !important;
    min-height: 17px !important;
  }
  ...
  .router-overview-framework .ik-v420-resource-visual.ik-v620-pressure-visual .ik-v420-resource-meter > i > i,
  .ik-v420-resource-visual.ik-v620-pressure-visual .ik-v420-resource-meter > i > i {
    background: rgba(168,50,43,.42) !important;
  }
  ...
  .ik-v420-list {
    ...
    box-shadow: inset 0 1px 0 rgba(145,169,193,.18), inset 0 -1px 0 rgba(145,169,193,.18) !important;
  }
  ...
  .ik-v420-tabs {
    ...
    box-shadow: 0 -1px 0 rgba(145,169,193,.28) !important;
  }

  /* v990: read-only monitor density pass.
     Remove the duplicate top rail and let the first viewport carry only:
     device status, one judgment card, one compact status ledger, ranking, tabs. */
  #overview.router-overview-framework .ik-v940-core-rail,
  .router-overview-framework .ik-v940-core-rail,
  .ik-v940-core-rail {
    display: none !important;
  ...
  .ik-v420-nav {
    ...
    gap: 7px !important;
    border-bottom: .5px solid rgba(142, 169, 196, .32) !important;
  }
  ...
  .ik-v420-nav strong {
    ...
    border: .5px solid rgba(142, 169, 196, .34) !important;
    font-size: 9.4px !important;
    line-height: 19px !important;
  }
  ...
  .ik-v420-hero {
    ...
    grid-template-rows: auto 72px 17px !important;
    gap: 4px !important;
    padding: 7px 9px 6px !important;
    border-radius: 7px !important;
    border: .5px solid rgba(142, 169, 196, .28) !important;
    background: linear-gradient(90deg, rgba(20,115,230,.035), rgba(255,255,255,.82) 18%, rgba(255,255,255,.78) 100%) !important;
  }

  #overview.router-overview-framework .ik-v420-hero.is-danger,
  .router-overview-framework .ik-v420-hero.is-danger,
  .ik-v420-hero.is-danger {
    background: linear-gradient(90deg, rgba(184,58,50,.030), rgba(255,255,255,.82) 18%, rgba(255,255,255,.78) 100%) !important;
  }
  ...
  .ik-v420-hero.is-warn,
  .ik-v420-hero.is-missing {
    background: linear-gradient(90deg, rgba(168,111,35,.030), rgba(255,255,255,.82) 18%, rgba(255,255,255,.78) 100%) !important;
  }
  ...
  .ik-v830-trust-rail {
    ...
    min-height: 17px !important;
    padding: 0 !important;
    border-top: .5px solid rgba(164,184,205,.28) !important;
  }
  ...
  .router-overview-framework .ik-v420-resource-visual.ik-v620-pressure-visual .ik-v420-resource-meter,
  .ik-v420-resource-visual.ik-v620-pressure-visual .ik-v420-resource-meter {
    grid-template-columns: 26px 34px 33px 40px minmax(0, 1fr) !important;
    min-height: 18px !important;
    gap: 4px !important;
  }
  ...
  .ik-v420-resource-visual.ik-v620-pressure-visual .ik-v420-resource-meter > i {
    height: 1px !important;
    background: rgba(139,164,190,.32) !important;
  }

  #overview.router-overview-framework .ik-v420-resource-visual.ik-v620-pressure-visual .ik-v420-resource-meter > i > i,
  .router-overview-framework .ik-v420-resource-visual.ik-v620-pressure-visual .ik-v420-resource-meter > i > i,
  .ik-v420-resource-visual.ik-v620-pressure-visual .ik-v420-resource-meter > i > i {
    background: rgba(184,58,50,.48) !important;
  }
  ...
  .ik-v420-timeline {
    padding: 0 9px !important;
    border-radius: 6px !important;
    border: .5px solid rgba(142,169,196,.24) !important;
    background: rgba(255,255,255,.58) !important;
  }
  ...
  .ik-v420-timeline-row {
    display: grid !important;
    grid-template-columns: 10px 58px 92px minmax(0, 1fr) !important;
    min-height: 44px !important;
    padding: 0 !important;
    gap: 5px !important;
    align-items: center !important;
    border-top: .5px solid rgba(195,210,225,.52) !important;
  }
  ...
  .ik-v420-list-row > i {
    ...
    border-radius: 6px !important;
    background: rgba(20,115,230,.055) !important;
    border: .5px solid rgba(20,115,230,.24) !important;
  }
  ...
  .ik-v420-tabs {
    height: calc(64px + env(safe-area-inset-bottom, 0px)) !important;
    min-height: calc(64px + env(safe-area-inset-bottom, 0px)) !important;
    padding: 2px 6px max(2px, env(safe-area-inset-bottom, 0px)) !important;
    border-radius: 0 !important;
  ...
  /* v991: protect business facts from clipping after density compression. */
  #overview.router-overview-framework .ik-v420-timeline-row,
  .router-overview-framework .ik-v420-timeline-row,
  .ik-v420-timeline-row {
    grid-template-columns: 10px 56px max-content minmax(0, 1fr) !important;
  }
  ...
  .ik-v420-interface-list span {
    ...
    grid-template-areas: "mark name" "mark note" !important;
    align-content: center !important;
    min-height: 34px !important;
    height: 34px !important;
    padding: 0 !important;
    gap: 0 6px !important;
    border: 0 !important;
    border-top: .5px solid rgba(195,210,225,.50) !important;
    border-radius: 0 !important;
    background: transparent !important;
  }
...
@media (max-width: 760px) {
  ...
  /* v900 density reset: read-only router monitor app, not a decorative card feed. */
  #overview.router-overview-framework .ik-v420-screen,
  .router-overview-framework .ik-v420-screen,
  .ik-v420-screen {
    gap: 6px !important;
    padding: max(8px, env(safe-area-inset-top, 0px)) 8px 72px !important;
  }
  ...
  #overview.router-overview-framework .ik-v420-nav button svg,
  .router-overview-framework .ik-v420-nav button svg,
  .ik-v420-nav button svg {
    width: 17px !important;
    height: 17px !important;
    stroke-width: 2 !important;
  }

  #overview.router-overview-framework .ik-v240-title,
  .router-overview-framework .ik-v240-title,
  .ik-v240-title {
    min-width: 0 !important;
    gap: 1px !important;
  }
  ...
  .ik-v240-status {
    ...
    font-size: 10px !important;
    line-height: 20px !important;
    border: .5px solid rgba(33, 132, 226, .22) !important;
    background: rgba(255,255,255,.72) !important;
    box-shadow: none !important;
  }

  #overview.router-overview-framework .ik-v240-status i,
  .router-overview-framework .ik-v240-status i,
  .ik-v240-status i {
    width: 5px !important;
    height: 5px !important;
    box-shadow: none !important;
  ...
  .router-overview-framework .ik-v420-hero,
  .ik-v420-hero {
    grid-template-rows: auto minmax(66px, auto) 22px !important;
    gap: 5px !important;
    max-height: 220px !important;
    padding: 8px 10px 7px !important;
    border-radius: 10px !important;
    background: rgba(255,255,255,.94) !important;
    box-shadow: inset 0 0 0 .5px rgba(142, 169, 196, .44) !important;
  }

  #overview.router-overview-framework .ik-v420-hero:is(.is-danger, .is-warn, .is-missing),
  .router-overview-framework .ik-v420-hero:is(.is-danger, .is-warn, .is-missing),
  .ik-v420-hero:is(.is-danger, .is-warn, .is-missing) {
    max-height: 240px !important;
    background: rgba(255,255,255,.96) !important;
  }
  ...
  .ik-v830-trust-rail {
    ...
    gap: 0 !important;
    border-top: .5px solid rgba(151, 172, 195, .34) !important;
  }
  ...
  #overview.router-overview-framework .ik-v830-trust-rail span + span,
  .router-overview-framework .ik-v830-trust-rail span + span,
  .ik-v830-trust-rail span + span {
    border-left: .5px solid rgba(151, 172, 195, .34) !important;
  }
  ...
  .router-overview-framework .ik-v420-app[data-overview-mobile-scene="resource-full"] .ik-v620-pressure-visual .ik-v420-resource-meter,
  .ik-v420-app[data-overview-mobile-scene="resource-full"] .ik-v620-pressure-visual .ik-v420-resource-meter {
    grid-template-columns: 28px 32px 34px 42px minmax(0, 1fr) !important;
    min-height: 17px !important;
  }
  ...
  .ik-v420-tabs {
    height: 66px !important;
    min-height: 66px !important;
    padding: 3px 6px max(3px, env(safe-area-inset-bottom, 0px)) !important;
    border-radius: 11px !important;
    background: rgba(255,255,255,.94) !important;
    box-shadow: inset 0 0 0 .5px rgba(142, 169, 196, .42) !important;
  }
  ...
  .ik-v420-tabs button.is-active svg {
    border-radius: 7px !important;
    background: rgba(33, 132, 226, .08) !important;
    box-shadow: inset 0 0 0 .5px rgba(33, 132, 226, .18) !important;
  }

  /* v910: fixed trust bus + scene-weighted mobile home. */
  #overview.router-overview-framework .ik-v910-trust-strip,
  .router-overview-framework .ik-v910-trust-strip,
  .ik-v910-trust-strip {
    display: grid !important;
    ...
    padding: 2px 0 !important;
    border: 0 !important;
    border-top: .5px solid rgba(160, 179, 199, .34) !important;
    border-bottom: .5px solid rgba(160, 179, 199, .34) !important;
    background: transparent !important;
    box-shadow: none !important;
    overflow: hidden !important;
  }
  ...
  .ik-v910-trust-strip span {
    ...
    min-height: 26px !important;
    padding: 0 6px !important;
    border-left: .5px solid rgba(160, 179, 199, .30) !important;
  }

  #overview.router-overview-framework .ik-v910-trust-strip span:first-child,
  .router-overview-framework .ik-v910-trust-strip span:first-child,
  .ik-v910-trust-strip span:first-child {
    border-left: 0 !important;
  }

  #overview.router-overview-framework .ik-v910-trust-strip b,
  .router-overview-framework .ik-v910-trust-strip b,
  .ik-v910-trust-strip b {
    grid-area: label !important;
  ...
  #overview.router-overview-framework .ik-v910-trust-strip strong,
  .router-overview-framework .ik-v910-trust-strip strong,
  .ik-v910-trust-strip strong {
    grid-area: value !important;
    color: var(--ik-ink) !important;
    font-size: 8.7px !important;
    line-height: 10px !important;
  ...
  #overview.router-overview-framework .ik-v910-trust-strip em,
  .router-overview-framework .ik-v910-trust-strip em,
  .ik-v910-trust-strip em {
    grid-area: note !important;
  ...
  #overview.router-overview-framework .ik-v910-trust-strip .is-missing strong,
  .router-overview-framework .ik-v910-trust-strip .is-warn strong,
  .router-overview-framework .ik-v910-trust-strip .is-missing strong,
  .ik-v910-trust-strip .is-warn strong,
  .ik-v910-trust-strip .is-missing strong {
  ...
  .router-overview-framework .ik-v420-hero,
  .ik-v420-hero {
    grid-template-rows: auto minmax(58px, auto) 20px !important;
    gap: 4px !important;
    padding: 7px 10px 6px !important;
    border-radius: 9px !important;
    background: rgba(255,255,255,.90) !important;
    box-shadow: inset 0 0 0 .5px rgba(162, 181, 201, .32) !important;
  }
  ...
  .router-overview-framework .ik-v420-port-matrix,
  .ik-v420-port-matrix {
    border-top: .5px solid rgba(162, 181, 201, .36) !important;
    border-left: .5px solid rgba(162, 181, 201, .36) !important;
    gap: 0 !important;
  }
  ...
  .ik-v420-port-matrix span {
    ...
    padding: 0 4px !important;
    border: 0 !important;
    border-right: .5px solid rgba(162, 181, 201, .36) !important;
    border-bottom: .5px solid rgba(162, 181, 201, .36) !important;
    border-radius: 0 !important;
    background: transparent !important;
  }
  ...
  #overview.router-overview-framework .ik-v420-port-matrix span.is-danger em,
  .router-overview-framework .ik-v420-port-matrix span.is-danger em,
  .ik-v420-port-matrix span.is-danger em {
    color: #a33a33 !important;
  }

  #overview.router-overview-framework .ik-v420-resource-visual.ik-v620-pressure-visual,
  .router-overview-framework .ik-v420-resource-visual.ik-v620-pressure-visual,
  .ik-v420-resource-visual.ik-v620-pressure-visual {
    border: .5px solid rgba(162, 181, 201, .34) !important;
    background: transparent !important;
  }
  ...
  .ik-v420-resource-visual.ik-v620-pressure-visual .ik-v420-resource-meter > i {
    height: 1.5px !important;
    background: rgba(146, 164, 184, .30) !important;
  }

  #overview.router-overview-framework .ik-v420-resource-visual.ik-v620-pressure-visual .ik-v420-resource-meter > i > i,
  .router-overview-framework .ik-v420-resource-visual.ik-v620-pressure-visual .ik-v420-resource-meter > i > i,
  .ik-v420-resource-visual.ik-v620-pressure-visual .ik-v420-resource-meter > i > i {
    background: #c8332d !important;
    box-shadow: none !important;
  }
  ...
  #overview.router-overview-framework .ik-v420-list[data-overview-mobile-list-kind="wan-incident"] article,
  #overview.router-overview-framework .ik-v420-list[data-overview-mobile-list-kind="interface-incident"] article,
  .router-overview-framework .ik-v420-list[data-overview-mobile-list-kind="wan-incident"] article,
  .router-overview-framework .ik-v420-list[data-overview-mobile-list-kind="interface-incident"] article,
  .ik-v420-list[data-overview-mobile-list-kind="wan-incident"] article,
  .ik-v420-list[data-overview-mobile-list-kind="interface-incident"] article {
    min-height: 46px !important;
  }

  #overview.router-overview-framework .ik-v420-list[data-overview-mobile-list-kind="wan-incident"] article:nth-of-type(n+5),
  #overview.router-overview-framework .ik-v420-list[data-overview-mobile-list-kind="interface-incident"] article:nth-of-type(n+5),
  .router-overview-framework .ik-v420-list[data-overview-mobile-list-kind="wan-incident"] article:nth-of-type(n+5),
  .router-overview-framework .ik-v420-list[data-overview-mobile-list-kind="interface-incident"] article:nth-of-type(n+5),
  .ik-v420-list[data-overview-mobile-list-kind="wan-incident"] article:nth-of-type(n+5),
  .ik-v420-list[data-overview-mobile-list-kind="interface-incident"] article:nth-of-type(n+5) {
    display: none !important;
  }
  ...
  .ik-v420-tabs {
    background: rgba(255,255,255,.90) !important;
    box-shadow: inset 0 0 0 .5px rgba(162, 181, 201, .34) !important;
  }
...
/* v930: high-density read-only router App home.  The goal is facts per
   centimetre, not decoration: compact chrome, thin separators, small status
   dots, chart readouts beside the chart, and no oversized semantic blocks. */
@media (max-width: 760px) {
  #overview.router-overview-framework .ik-v420-app,
  .router-overview-framework .ik-v420-app,
  .ik-v420-app {
    ...
    background:
      linear-gradient(180deg, rgba(249,252,255,.96) 0%, rgba(242,248,253,.96) 100%) !important;
  }

  #overview.router-overview-framework .ik-v420-screen,
  .router-overview-framework .ik-v420-screen,
  .ik-v420-screen {
    padding: max(6px, env(safe-area-inset-top, 0px)) 12px 74px !important;
  }
  ...
  .ik-v420-nav {
    ...
    grid-template-columns: 34px minmax(0, 1fr) auto !important;
    gap: 8px !important;
    border-bottom: .5px solid rgba(139, 164, 190, .34) !important;
  }
  ...
  .ik-v420-nav strong {
    ...
    line-height: 22px !important;
    background: rgba(255,255,255,.54) !important;
    box-shadow: inset 0 0 0 .5px rgba(142, 169, 196, .40) !important;
  }

  #overview.router-overview-framework .ik-v420-nav i,
  .router-overview-framework .ik-v420-nav i,
  .ik-v420-nav i {
    width: 5px !important;
    height: 5px !important;
  ...
  .ik-v910-trust-strip span {
    ...
    padding: 0 4px !important;
    gap: 2px !important;
    border-left: .5px solid rgba(151, 172, 195, .26) !important;
  }
  ...
  .ik-v420-hero {
    min-height: 0 !important;
    max-height: 240px !important;
    grid-template-rows: auto minmax(62px, auto) 20px !important;
    gap: 5px !important;
    padding: 8px 10px 7px !important;
    border-radius: 8px !important;
    background:
      linear-gradient(90deg, rgba(33,132,226,.055), rgba(255,255,255,.92) 21%, rgba(255,255,255,.90) 100%) !important;
    box-shadow: inset 0 0 0 .5px rgba(142, 169, 196, .34) !important;
  }
  ...
  .ik-v420-hero.is-danger {
    background:
      linear-gradient(90deg, rgba(217,48,37,.045), rgba(255,255,255,.92) 21%, rgba(255,255,255,.90) 100%) !important;
  }
  ...
  .ik-v420-hero.is-missing {
    background:
      linear-gradient(90deg, rgba(223,129,40,.045), rgba(255,255,255,.92) 21%, rgba(255,255,255,.90) 100%) !important;
  }
  ...
  .router-overview-framework .ik-v420-resource-visual.ik-v620-pressure-visual .ik-v420-resource-meter,
  .ik-v420-resource-visual.ik-v620-pressure-visual .ik-v420-resource-meter {
    grid-template-columns: 27px 34px 34px 40px minmax(0, 1fr) !important;
    min-height: 19px !important;
    gap: 4px !important;
  }

  #overview.router-overview-framework .ik-v420-resource-visual b,
  .router-overview-framework .ik-v420-resource-visual b,
  .ik-v420-resource-visual b {
    font-size: 10px !important;
  }

  #overview.router-overview-framework .ik-v420-resource-visual strong,
  .router-overview-framework .ik-v420-resource-visual strong,
  .ik-v420-resource-visual strong {
    font-size: 10px !important;
  }

  #overview.router-overview-framework .ik-v420-resource-visual small,
  #overview.router-overview-framework .ik-v420-resource-visual em,
  .router-overview-framework .ik-v420-resource-visual small,
  .router-overview-framework .ik-v420-resource-visual em,
  .ik-v420-resource-visual small,
  .ik-v420-resource-visual em {
    font-size: 8.6px !important;
  }
  ...
  .ik-v420-list {
    ...
    box-shadow: inset 0 0 0 .5px rgba(151, 172, 195, .28) !important;
  }
  ...
  .router-overview-framework .ik-v420-timeline-row,
  .ik-v420-timeline-row {
    grid-template-columns: 12px minmax(0, .92fr) minmax(86px, auto) !important;
    min-height: 44px !important;
    padding: 2px 0 !important;
    gap: 6px !important;
  }
  ...
  .ik-v420-list-row > i {
    ...
    height: 28px !important;
    border-radius: 6px !important;
    background: rgba(33,132,226,.07) !important;
    box-shadow: inset 0 0 0 .5px rgba(33,132,226,.30) !important;
  }
  ...
  .ik-v420-tabs {
    height: 64px !important;
    min-height: 64px !important;
    padding: 2px 6px max(3px, env(safe-area-inset-bottom, 0px)) !important;
...
${MOBILE_OVERVIEW_PRODUCT_STYLES}
