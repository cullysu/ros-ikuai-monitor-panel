var PanelFramework = function(exports) {
  ...
  const MOBILE_OVERVIEW_CORE_STYLES = `
...
`;
  const MOBILE_OVERVIEW_DECISION_STYLES = `
@media (max-width: 760px), (min-width: 761px) and (max-width: 900px) and (max-height: 520px) {
...
`;
  const MOBILE_OVERVIEW_FRAME_STYLES = `
@media (max-width: 760px), (min-width: 761px) and (max-width: 900px) and (max-height: 520px) {
...
`;
  const MOBILE_OVERVIEW_PRODUCT_SHELL_STYLES = MOBILE_OVERVIEW_CURRENT_SHELL_STYLES;
  const MOBILE_OVERVIEW_SURFACE_STYLES = `
@media (max-width: 760px), (min-width: 761px) and (max-width: 900px) and (max-height: 520px) {
