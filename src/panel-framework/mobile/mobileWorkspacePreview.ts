...
export type MobileWorkspacePreviewLabel =
  | "风险对象"
  | "默认出口"
  | "活动默认路由"
  | "最近记录"
...
export interface MobileWorkspacePreview {
  row: WorkspaceRow;
  label: MobileWorkspacePreviewLabel;
}

export function selectSemanticWorkspacePreview(rows: WorkspaceRow[]): MobileWorkspacePreview | null {
