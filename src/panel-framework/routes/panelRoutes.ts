...
export type PanelTaskGroup = "overview" | "interfaces" | "terminals" | "logs" | "more";
...
export function routeUrl(route: PanelRouteId, location: Pick<Location, "pathname" | "search"> = window.location): string {
