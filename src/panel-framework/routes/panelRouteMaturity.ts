...
const sectionEvidence = (
  ...
  modelToken,
  rendererSource: "src/panel-framework/mobile-pulse-ui/workspace/MobilePulseRoutes.tsx",
  rendererToken: "data-panel-route-content={route}",
  objectDetailSource: "src/panel-framework/mobile-pulse-ui/workspace/MobilePulseWorkspace.tsx",
  objectDetailToken: "data-ikuai4-mobile-scroll=\"detail\"",
  ...
  evidenceRefs: [
    ...
    "src/panel-framework/mobile-pulse-ui/workspace/MobilePulseRoutes.tsx",
...
export const PANEL_ROUTE_MATURITY_EVIDENCE: Record<PanelRouteId, PanelRouteMaturityEvidence> = {
  overview: {
    ...
    rendererSource: "src/panel-framework/mobile-pulse-ui/overview/MobilePulseOverview.tsx",
    rendererToken: "data-ikuai-mobile-home",
    objectDetailSource: "src/panel-framework/mobile-pulse-ui/workspace/MobilePulseWorkspace.tsx",
    objectDetailToken: "data-ikuai4-mobile-scroll=\"detail\"",
    ...
    accessibilitySource: "src/panel-framework/mobile-pulse-ui/overview/MobilePulseOverview.tsx",
    accessibilityToken: "data-ikuai-mobile-home",
    dataDepth: "domain-specific",
    objectDetail: "novel",
    failureRecovery: "route-specific",
    ...
    evidenceRefs: [
      ...
      "src/panel-framework/mobile-pulse-ui/overview/MobilePulseOverview.tsx",
      "src/panel-framework/mobile-pulse-ui/workspace/MobilePulseRoutes.tsx",
      "src/panel-framework/mobile-native-ui/styles/overview.css",
      ...currentAutomatedEvidence,
    ],
  },
  interfaces: {
  ...
  more: {
    ...
    rendererSource: "src/panel-framework/mobile-pulse-ui/workspace/MobilePulseRoutes.tsx",
    rendererToken: 'data-ikuai4-mobile-route="more"',
    objectDetailSource: "src/panel-framework/mobile-pulse-ui/workspace/MobilePulseWorkspace.tsx",
    objectDetailToken: 'data-panel-route-content="more"',
