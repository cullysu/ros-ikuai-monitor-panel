type MobileBottomNavItem = {
  ...
  note: string;
  active: boolean;
  section: "overview" | "balance" | "interfaces" | "dhcp" | "logs";
  path: string;
};
...
function activateMobileSection(section: MobileBottomNavItem["section"]) {
  const shellLink = document.querySelector<HTMLAnchorElement>(
