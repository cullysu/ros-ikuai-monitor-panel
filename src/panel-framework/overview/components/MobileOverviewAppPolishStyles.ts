...
export const V1065_NORMAL_NATIVE_SUMMARY = `
@media (max-width: 760px) {
...
export const V1066_ROUTER_BOTTOM_TABS = `
@media (max-width: 760px) {
...
export const V1067_ROUTER_STATUS_HEADER_ACTION = `
@media (max-width: 760px) {
...
export const MOBILE_OVERVIEW_NATIVE_PRODUCT_STYLES =
  `${V1010_MOBILE_NATIVE_APP_POLISH}${V1020_PUBLIC_PRODUCT_POLISH}${V1030_NATIVE_TRUST_SPINE}${V1058_COLLECTION_TRUST_RAIL_POLISH}${V1065_NORMAL_NATIVE_SUMMARY}${V1066_ROUTER_BOTTOM_TABS}${V1067_ROUTER_STATUS_HEADER_ACTION}${V1070_GROUPED_SURFACE_LOW_BORDER}`;
