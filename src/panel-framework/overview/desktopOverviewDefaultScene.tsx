...
export function buildDefaultDesktopScene(
  ...
  const terminalRanking = <TerminalRanking key="compact-terminals" title="终端排行" subtitle="按总流量排序" module="terminal-ranking" tone="trust" trust={trust} headers={["设备", "IP", "流量", "状态"]} rows={compactRows(desktopTerminalRows(snapshot), isFleet ? 4 : 6)} minRows={0} collapsed />;
  return {
    main: [
