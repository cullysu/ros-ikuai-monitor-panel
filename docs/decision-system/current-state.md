...
- boundary: Step784 binds the clean candidate 71ee8fc to the next exact-SHA evidence run; prior runtime reports are not promoted across SHA.
...
- Next: commit this candidate-binding record, then run exact-SHA clean build/runtime/overview and full overview/route state evidence.
