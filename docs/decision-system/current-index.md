...
- Current engineering repair: `42d1d1d…` passed base gates, then full release gates exposed a transient DNS ownership classification in forced-colors inventory. Stable ownership plus dedicated DNS pagination focus coverage passes focused replay; another clean SHA is required.
