...
- Current engineering boundary: Step892 records the runtime global-timeout stabilization after two 240-second batch timeouts; all prior exact-SHA evidence is stale until the new timeout contract is rebound. Formal trusted acceptance and release gates remain open.
