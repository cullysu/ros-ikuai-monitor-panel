...
| 877 - 878 | packet authority binding, report quarantine current-evidence isolation, exact-SHA rebinding boundary and fail-closed formal gates | current-state.md |
