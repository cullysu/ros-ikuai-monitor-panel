...
| 839 - 847 | decision-first mobile ordering, wide resource action correction, exact-SHA matrix rebinding, browser cleanup reliability, current-SHA scoped independent reviews, exact report discovery, current-SHA matrix rebinding and formal-gate fail-closed continuation | current-state.md |
