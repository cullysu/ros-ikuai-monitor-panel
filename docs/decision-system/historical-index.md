...
| 811 - 824 | current-candidate visual/runtime evidence, accessibility coverage, exact-SHA matrix rebinding, artifact identity repair, unsigned visual packet generation, scoped visual closure, final matrix/archive repair and runtime cleanup reliability | current-state.md |
