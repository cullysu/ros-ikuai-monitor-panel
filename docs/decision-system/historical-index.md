...
| 839 - 843 | decision-first mobile ordering, wide resource action correction, exact-SHA matrix rebinding, scoped review boundary and formal-gate fail-closed continuation | current-state.md |
