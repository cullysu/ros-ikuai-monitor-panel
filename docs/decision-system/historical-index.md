...
| 871 - 875 | exact-SHA evidence rebinding, route-responsive report discovery, full route scenario evidence, scoped visual closure, and normal-phone primary next-step ordering | current-state.md |
