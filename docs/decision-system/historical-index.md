...
| 839 - 844 | decision-first mobile ordering, wide resource action correction, exact-SHA matrix rebinding, browser cleanup reliability and formal-gate fail-closed continuation | current-state.md |
