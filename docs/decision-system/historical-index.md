...
| 811 - 823 | current-candidate visual/runtime evidence, accessibility coverage, exact-SHA matrix rebinding, artifact identity repair, unsigned visual packet generation, scoped visual closure and final matrix/archive repair | current-state.md |
