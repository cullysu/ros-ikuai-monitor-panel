...
| 839 - 845 | decision-first mobile ordering, wide resource action correction, exact-SHA matrix rebinding, browser cleanup reliability, current-SHA scoped independent reviews and formal-gate fail-closed continuation | current-state.md |
