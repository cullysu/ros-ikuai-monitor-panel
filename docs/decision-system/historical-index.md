...
| 811 - 827 | current-candidate visual/runtime evidence, accessibility coverage, exact-SHA matrix rebinding, artifact identity repair, unsigned visual packet generation, scoped visual closure, final matrix/archive repair, runtime cleanup reliability, deterministic connection capture and final release-boundary verification | current-state.md |
