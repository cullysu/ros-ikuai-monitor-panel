...
| 850 - 860 | exact-SHA rebinding, scoped reviews, route-object evidence, bounded report quarantine, exact-SHA visual review and formal release gates remaining open | current-state.md |
