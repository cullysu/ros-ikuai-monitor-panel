...
- process: current-state.md is the sole authority; panel-redesign-decision-log.md is the detailed chronology.
...
- Boundary: engineering, runtime/matrix evidence and scoped Design/Visual review are green; Product, route maturity, accessibility, readiness, RouterOS soak and exact-SHA CL remain open.
