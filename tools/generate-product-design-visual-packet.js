...
const evidenceFiles = [
  ...
  "mobile-visual-667-single.png",
  "mobile-visual-667-fleet.png",
  "mobile-visual-667-all-offline.png",
  "mobile-visual-667-no-snapshot.png",
  "mobile-visual-667-collection-down.png",
  "mobile-visual-667-resource-full.png",
  "mobile-visual-667-interfaces-down.png",
  ...
  reviewScopes: [
    {
      ...
      viewports: ["390x844", "375x667", "430x932", "667x375", "768x1024", "844x390"],
      evidence: ["mobile-runtime-current.png", "mobile-composite-risk-390.png", "mobile-composite-risk-375.png", "mobile-visual-430-single.png", "mobile-visual-430-resource-full.png", "mobile-visual-430-collection-down.png", "mobile-visual-430-interfaces-down.png", "mobile-visual-667-single.png", "mobile-visual-667-fleet.png", "mobile-visual-667-all-offline.png", "mobile-visual-667-no-snapshot.png", "mobile-visual-667-collection-down.png", "mobile-visual-667-resource-full.png", "mobile-visual-667-interfaces-down.png", "mobile-log-explicit-detail-390.png"],
    },
    {
      id: "R09",
