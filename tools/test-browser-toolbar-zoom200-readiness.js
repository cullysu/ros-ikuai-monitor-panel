...
assert.match(windowsZoomSource, /raw_search_containers = tuple\(owned_windows\)[\s\S]*raw_search_containers \+= \(window,\)[\s\S]*find_bounded_raw_matches\(/, 'The original Edge root may only re-enter Zoom lookup through the bounded RawView fallback');
