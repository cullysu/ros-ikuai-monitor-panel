...
assert.match(windowsZoomSource, /NoPatternInterfaceError[\s\S]*iface_legacy_iaccessible\.DoDefaultAction\(\)/, 'Edge activation must retain a UIA LegacyIAccessible fallback without physical input');
