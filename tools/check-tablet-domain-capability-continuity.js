...
const compactQuery = /COMPACT_TASK_QUERY\s*=\s*["'][^"']*min-width:\s*600px[^"']*max-width:\s*767px[^"']*["']/;
...
const workbenchLayout = /\.mdw-shell\.is-tablet-workbench\s+\.mdw-layout[\s\S]{0,900}grid-template-columns:\s*minmax\(268px[\s\S]*minmax\(420px/;
...
const checks = {
  compactQueryEndsAt767: compactQuery.test(surface),
