...
includesAll(`${read("src/panel-framework/overview/components/BottomTabs.tsx")}\n${mobileAppPolishStyles}\n${mobileStyles}\n${resourceTrendCheck}`, [
  ...
  "data-overview-mobile-tab-target",
  "data-overview-mobile-tab-view",
  "data-overview-mobile-tab-credibility",
  "mobileNavigation",
  "mobileNavigationNoSnapshot",
  "mobileDetailDrilldown",
  "mobileIncidentDrilldown",
  "aria-expanded",
  "awaitPromise: true",
  "status-overview",
  "multi-wan",
