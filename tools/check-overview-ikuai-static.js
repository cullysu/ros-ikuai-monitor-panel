...
assert(predeploy.includes('overviewMobile390FirstScreenVisualOk'), 'predeploy must require a real mobile first-screen visual');
...
assert(predeploy.includes("type === 'line' || type === 'bar'") && predeploy.includes('graphicMarks >= 2'), 'predeploy must require real marks for line/bar charts');
...
assert(predeploy.includes('overviewMobile390NoAppHomeTitleClipOk &&'), 'predeploy must include title clipping in the mobile acceptance gate');
assert(predeploy.includes('overviewMobile390NoCoreTextClipOk &&'), 'predeploy must include core text clipping in the mobile acceptance gate');
